...
export function ColorPickerUI() {
  ...
  return (
    ...
    >
      ...
      <div className="text-sm text-ink/70 max-w-[260px]">
        {heldColor
          ? "Đang cầm màu này — nhắm vào người mình, giữ chuột trái: camera đứng yên, di chuyển chuột để chọn đúng vị trí vẽ"
