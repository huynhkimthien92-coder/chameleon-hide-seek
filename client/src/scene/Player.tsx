...
export function Player() {
  ...
  useFrame((_state, delta) => {
    ...
    // Bảng vẽ đang mở, hoặc đang pha chuẩn bị mà mình là Seeker -> tạm dừng
    // di chuyển ngang (vẫn rơi/đứng trên sàn bình thường qua KCC ở dưới).
    ...
    if (!isPaintBoardOpen && !isSeekerWaitingToPrep) {
